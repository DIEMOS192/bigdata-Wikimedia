...
- File: pagecounts-20160101-000000_parsed.out (Zipped version is at data/pagecounts.zip, you just unzip it)
...
python spark_app.py --input data/pagecounts-20160101-000000_parsed.out
